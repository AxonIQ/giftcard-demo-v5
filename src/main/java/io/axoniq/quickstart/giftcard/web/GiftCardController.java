...
public class GiftCardController {
    ...
    public Flux<GiftCardStreamUpdate> getAllGiftCardUpdates() {
        return Flux.from(
                queryGateway.subscriptionQuery(new FindAllGiftCardsQuery(),
                        GiftCardStreamUpdate.class,
                        queryResponseMessage -> {
                            if (queryResponseMessage instanceof SubscriptionQueryUpdateMessage) {
                                return new GiftCardStreamUpdate(
                                        null,
                                        queryResponseMessage.payloadAs(GiftCardSummary.class, converter)
                                );
                            } else {
                                return new GiftCardStreamUpdate(
                                        queryResponseMessage.payloadAs(GiftCardSummaryList.class, converter).giftCards(),
                                        null
                                );
                            }
                        })
