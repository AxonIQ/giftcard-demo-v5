 ...
 *   <li>The redemption amount must be positive (validated by the EventSourced DCB model)</li>
 *   <li>The redemption amount cannot exceed the current remaining balance (validated by the EventSourced DCB model)</li>
 * </ul>
 *
 * <p>Use cases:</p>
 * <ul>
